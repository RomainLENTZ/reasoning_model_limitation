...
| N | Min moves | No thinking (accuracy) | With thinking (accuracy) | Thinking tokens avg |
|---|-----------|------------------------|--------------------------|---------------------|
| 1 | 1 | **100%** | **100%** | 533 |
| 2 | 3 | **100%** | **100%** | 843 |
| 3 | 7 | **100%** | **100%** | 1,131 |
...
| 5 | 31 | **100%** | **100%** | 5,623 |
| 6 | 63 | **0%** | **100%** | 6,166 |
| 7 | 127 | **100%** | **100%** | 21,435 |
| 8 | 255 | **0%** | **0%** ← COLLAPSE | 32,561 |
| 9 | 511 | **0%** | **0%** ← COLLAPSE | ~32,567 |
| 10 | 1023 | **0%** | **0%** ← COLLAPSE | 32,573 |
